...
import xyz.baudelaplace.bmvp.framework.exceptions.ViewAlreadyDeclaredException;
import xyz.baudelaplace.bmvp.framework.views.PlaceholderView;
...
public abstract class Presenter<B extends Binding> implements BindingConsumer<B> {
	...
	private class PrivateBindingOwner extends BindingOwner {
		...
		@Override
		OutBinding<? extends xyz.baudelaplace.bmvp.framework.binding.Binding> getViewOutBinding() {
